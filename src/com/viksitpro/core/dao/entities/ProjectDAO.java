 ...
 * 
 * @see com.viksitpro.core.dao.entities.Project
...
public class ProjectDAO extends BaseHibernateDAO {
	...
	public Project findById(java.lang.Integer id) {
		...
		try {
			Project instance = (Project) getSession().get("com.viksitpro.core.dao.entities.Project", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Project> findByExample(Project instance) {
		...
		try {
			List<Project> results = (List<Project>) getSession()
					.createCriteria("com.viksitpro.core.dao.entities.Project").add(create(instance)).list();
	...
	public List<Project> findByActive(Object active) {
