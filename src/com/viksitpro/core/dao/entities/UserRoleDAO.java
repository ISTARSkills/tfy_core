 ...
 * 
 * @see com.viksitpro.core.dao.entities.UserRole
...
public class UserRoleDAO extends BaseHibernateDAO {
	...
	public UserRole findById(java.lang.Integer id) {
		...
		try {
			UserRole instance = (UserRole) getSession().get("com.viksitpro.core.dao.entities.UserRole", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<UserRole> findByExample(UserRole instance) {
		...
		try {
			List<UserRole> results = (List<UserRole>) getSession()
					.createCriteria("com.viksitpro.core.dao.entities.UserRole").add(create(instance)).list();
	...
	public List<UserRole> findByPriority(Object priority) {
