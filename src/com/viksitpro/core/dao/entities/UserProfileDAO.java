 ...
 * 
 * @see com.viksitpro.core.dao.entities.UserProfile
...
public class UserProfileDAO extends BaseHibernateDAO {
	...
	public UserProfile findById(java.lang.Integer id) {
		...
		try {
			UserProfile instance = (UserProfile) getSession().get("com.viksitpro.core.dao.entities.UserProfile", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<UserProfile> findByExample(UserProfile instance) {
		...
		try {
			List<UserProfile> results = (List<UserProfile>) getSession()
					.createCriteria("com.viksitpro.core.dao.entities.UserProfile").add(create(instance)).list();
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding UserProfile instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from UserProfile as model where model." + propertyName + "= ?";
	...
	public List<UserProfile> findByFirstName(Object firstName) {
		return findByProperty(FIRST_NAME, firstName);
	}

	public List<UserProfile> findByLastName(Object lastName) {
		return findByProperty(LAST_NAME, lastName);
	}

	public List<UserProfile> findByGender(Object gender) {
		return findByProperty(GENDER, gender);
	}

	public List<UserProfile> findByProfileImage(Object profileImage) {
		return findByProperty(PROFILE_IMAGE, profileImage);
	}

	public List<UserProfile> findByAadharNo(Object aadharNo) {
		return findByProperty(AADHAR_NO, aadharNo);
	}
	...
	public UserProfile merge(UserProfile detachedInstance) {
		...
		try {
			UserProfile result = (UserProfile) getSession().merge(detachedInstance);
