 ...
 * 
 * @see com.viksitpro.core.dao.entities.Address
...
public class AddressDAO extends BaseHibernateDAO {
	...
	public static final String ADDRESS_GEO_LONGITUDE = "addressGeoLongitude";
	public static final String ADDRESS_GEO_LATITUDE = "addressGeoLatitude";
	...
	public List<Address> findByExample(Address instance) {
		...
		try {
			List<Address> results = (List<Address>) getSession()
					.createCriteria("com.viksitpro.core.dao.entities.Address").add(create(instance)).list();
	...
	public List<Address> findByAddressGeoLongitude(Object addressGeoLongitude) {
		return findByProperty(ADDRESS_GEO_LONGITUDE, addressGeoLongitude);
	}

	public List<Address> findByAddressGeoLatitude(Object addressGeoLatitude) {
		return findByProperty(ADDRESS_GEO_LATITUDE, addressGeoLatitude);
	}
