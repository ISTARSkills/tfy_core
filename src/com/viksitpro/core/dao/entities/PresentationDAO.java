 ...
 * 
 * @see com.viksitpro.core.dao.entities.Presentation
 * @author MyEclipse Persistence Tools
 */
public class PresentationDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory.getLogger(PresentationDAO.class);
	// property constants
	...
	public Presentation findById(java.lang.Integer id) {
		...
		try {
			Presentation instance = (Presentation) getSession().get("com.viksitpro.core.dao.entities.Presentation", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Presentation> findByExample(Presentation instance) {
		...
		try {
			List<Presentation> results = (List<Presentation>) getSession()
					.createCriteria("com.viksitpro.core.dao.entities.Presentation").add(create(instance)).list();
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Presentation instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from Presentation as model where model." + propertyName + "= ?";
	...
	public Presentation merge(Presentation detachedInstance) {
		...
		try {
			Presentation result = (Presentation) getSession().merge(detachedInstance);
