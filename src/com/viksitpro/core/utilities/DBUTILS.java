...
Transaction tx = null;
	...
	public void syncPkeySeq(String table_name, String pkey_seq) {
		...
		try {
			...
			//ViksitLogger.logMSG(this.getClass().getName(),"DONE: DBUTILS::syncPkeySeq -> syncSeq --> " + syncSeq + pkey_seq + " ---> " + seq_val);
		} catch (Exception e) {
			//ViksitLogger.logMSG(this.getClass().getName(),("FAIL: DBUTILS::syncPkeySeq -> syncSeq --> " + syncSeq);
			e.printStackTrace();
		}
		return;
	}
