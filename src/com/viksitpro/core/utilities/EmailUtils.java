...
public class EmailUtils {
	  ...
	  public static void sendEmail(HttpServletRequest request, String emailTo,  String subject, String message) throws AddressException, MessagingException {
	        ...
	        try {
				...
				messageNew.append("\n\n\nFull Stacktrace: " +  ExceptionUtils.getRootCauseStackTrace(((Throwable) request.getAttribute("javax.servlet.error.exception"))));
	  ...
	  public static void sendEmail( String emailTo,  String subject, String message) throws AddressException, MessagingException {
