...
@WebServlet("/add_lo_to_lesson")
public class AddLoToLesson extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public AddLoToLesson() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(los.length!=0)
		{
			String deleteOldLOMap ="delete from lesson_skill_objective where lessonid="+lessonId;
			...
			for(HashMap<String, Object> row:  loContextMap)
			{
				...
				String insertIntoLessonSkillObjective ="insert into lesson_skill_objective (lessonid, learning_objectiveid, context_id) values("+lessonId+","+loId+","+context+");";
